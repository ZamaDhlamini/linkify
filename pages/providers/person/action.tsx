...
import { IAuth, ILogin, IUser, IUsersStateContext } from "./context";
...
export const LoginUserRequestAction = createAction<IUsersStateContext, IAuth>(UsersActionEnums.LoginUserRequest, (auth) => ({auth}));
